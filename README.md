...
The synchronizer rejects duplicate or malformed slugs and unexpected source URL schemes. The digest detects accidental snapshot corruption; it is not a substitute for signed releases or human review.
